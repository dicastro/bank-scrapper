package com.diegocastroviadero.bankscrapper.scrapper.kb.keyboard;
...
public class KeyboardManager {
    ...
    private int processKeyboardImagesNatively(final CandidateKey keyImage) throws UnparseableKeyboardException {
        ...
        if (tesseractCommandLocation.isFile() && tesseractCommandLocation.exists() && tesseractCommandLocation.canExecute()) {
            ...
            final ScrappingProperties.TesseractProperties tessCfg = properties.getTesseract();
            ...
            try {
                ...
                if (exitValue == 0) {
                    final String parsedKeyDigit = Files.readAllLines(outputFilePath).getFirst();
